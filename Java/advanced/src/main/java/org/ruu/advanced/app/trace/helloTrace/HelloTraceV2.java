...
public class HelloTraceV2 {
  ...
  public TraceStatusV1 beginSync(TraceIdV1 beforeTraceId, String message) {
    TraceIdV1 nextId = beforeTraceId.createNextId();
    Long startTimeMs = System.currentTimeMillis();
    log.info("[{}] {}{}", nextId.getId(), addSpace(START_PREFIX,
      nextId.getLevel()), message);
    return new TraceStatusV1(nextId, startTimeMs, message);
  }
